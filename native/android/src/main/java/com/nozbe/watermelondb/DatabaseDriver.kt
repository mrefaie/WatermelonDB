...
class DatabaseDriver(context: Context, dbName: String, dbQuery: String) {
    ...
    constructor(context: Context, dbName: String, dbQuery: String, schemaVersion: SchemaVersion) :
            this(context, dbName, dbQuery) {
    ...
    constructor(context: Context, dbName: String, dbQuery: String, schema: Schema) : this(context, dbName, dbQuery) {
        unsafeResetDatabase(schema)
    }

    constructor(context: Context, dbName: String, dbQuery: String, migrations: MigrationSet) :
            this(context, dbName, dbQuery) {
        migrate(migrations)
    }

    private val database: Database = Database(dbName, dbQuery, context)
